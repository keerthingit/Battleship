...
//Name: Keerthi Kiran
//Date: 06/02/2021 - 17/02/2021
//Purpose: use 2D array to create a fun computer vs user game!
...
namespace BattleShip
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Size of the Board, Enhancement 2 
            int Size;
            do
            {
        ...
        public static void battleShipDebug(int BoardSize)
        {
            ...
            //Ship Types and Numbers Generated Randomly According to BoardSize
        ...
        public static void battleShip(int BoardSize)//same thing as the debug method but this one doesn't show enemy's map, shows empty enemy's map
        {
            ...
            //Ship Types and Numbers Generated Randomly According to BoardSize, Enhancement 2 
            Random Rand = new Random();//to randomize coordinates
